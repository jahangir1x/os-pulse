...
class FridaController:
    ...
    def attach_to_all_processes(self, filter_name: Optional[str] = None) -> bool:
        ...
        excluded_names = [
            ...
            'System', 'csrss.exe', 'smss.exe', 'wininit.exe', 'services.exe', 'zrok.exe', 'tshark.exe', 'mitmproxy.exe', 'mitmdump.exe', 'WindowsTerminal.exe', 'OpenConsole.exe', 'dwm.exe', 'winlogon.exe', 'deskflow-daemon.exe',
