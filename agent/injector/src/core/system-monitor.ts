...
export class SystemMonitor {
    ...
    constructor(config?: Partial<HookConfiguration>, logger?: Logger) {
        ...
        this.fileMonitor = new FileOperationsMonitor(this.logger, this.config, eventSender);
        this.processMonitor = new ProcessCreationMonitor(this.logger, this.config, eventSender);
    }
